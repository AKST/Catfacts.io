@cat-facts = [
  ...
  * "Cats sweat only through their paws. Cats don’t have sweat glands over their bodies like humans do. Instead, they sweat only through their paws."
  ...
  * "Removing a cat's whiskers would endanger them greatly as they would lose all sense of direction and fall down deep holes or ravines or crash into objects such as trees."
  ...
  * "Snoop Dog is a cat lover, he has two cats, Frank Sinatra and Miles Davis."
  * "A male cat is called a 'tom', a female cat is called a 'molly' or 'queen', and young cats are called 'kittens'."
  * "More cats are owned than dogs. There are over 87 million cats owned and only 72 million dogs. That's a staggering 20% more."
